...
function scwShow(scwEle,scwSourceEle,businessName,baseYearLimit,dropDownYears,weekStartDay,weekNumberDisplay,weekNumberBaseDay,allowDrag,outOfMonthDisable,outOfMonthHide,HorizontalAlignment,VerticalAlignment,OffsetLeftAlignment,OffsetTopAlignment){
    var elemID = scwEle.id;
    var elemPos = $("#" + elemID).offset();
    elemTopPostion = elemPos.top
    elemLeftPosition = elemPos.left 
    setTimeout(function () {
        $('.date-control').css({
            opacity:1,
            top: elemTopPostion + 30,
...
//scwID('scwIframe').style.display='block'}
scwID('scw').style.display = 'block'
...
function scwHide()
{scwID('scw').style.display='none'
if(scwID('scwIframe')){scwID('scwIframe').style.display='none'}
...
scwCell.style.display = (scwOutOfMonthHide && (scwShowDate < (new Date(scwShowDate.getFullYear(), scwCurMonth, 1, scwShowDate.getHours()))
||scwShowDate>(new Date(scwShowDate.getFullYear(),scwCurMonth+1,0,scwShowDate.getHours()))))?'none':''
for(var k=0;k<scwDisabledDates.length;k++)
...
scwID('scw').style.display='none'
scwID('scw').style.display='block'}
document.write("<table id='scw' class='scw date-control'>"+
"<tr class='scw'>"+
"<td class='scw'>"+
...
"<tr class='scwHead' >"+
"<td class='scwHead'>"+
"<button class='scwHead' id='scwHeadLeft' type='button' value='<' "+
"onclick='scwShowMonth(-1);'> < </button></td>"+
"<td class='scwHead'>"+
"<select id='scwMonths' class='scwHead no-select2' "+
"onchange='scwShowMonth(0);'>"+
"</select>"+
"</td>"+
"<td class='scwHead'>"+
"<select id='scwYears' class='scwHead no-select2' "+
"onchange='scwShowMonth(0);'>"+
"</select>"+
"</td>"+
"<td class='scwHead'>"+
"<button class='scwHead' id='scwHeadRight' type='button' "+
"onclick='scwShowMonth(1);'>></button></td>" +
"</tr>"+
"</table>"+
"</td>"+

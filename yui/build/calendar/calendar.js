...
* @type String
*/
YAHOO.widget.CalendarGroup.CSS_CONTAINER = "yui-calcontainer yui-datepicker";
...
//datepicker postioning Fn- 17 JULY 2018
var yuiDatePickerPostion = debounce(function () {
    var datePickerInput = $('[data-calendar-contentID]');   
    if (datePickerInput.length) {
        datePickerInput.each(function () {
            var $this = $(this);
            var elem = $this.attr('data-calendar-contentID');
            ...
            $(elem).each(function () {
				...
				$(this).attr('data-width',elemWidth)
                if (elemWidth < 508 && !$(this).hasClass('single') || elemWidth < 270 && $(this).hasClass('single')) {
                    $(this).css({
                        'left': 'auto',
                        'right': '20px'
                    });
...
$(document.body).on("click", yuiDatePickerPostion);
$(window).on("load resize", yuiDatePickerPostion);
